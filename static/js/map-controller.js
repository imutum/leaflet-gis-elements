...
class MapController {
    ...
    _createControls() {
        ...
        this.controls.northArrow = new NorthArrowControl({
        ...
        this.controls.scaleBar = new ScaleBarControl({
        ...
        this.controls.graticule = new GraticuleControl({
        ...
        // 创建导出控件
        if (typeof ExportControl !== 'undefined') {
...
// 向后兼容：保留旧名称
window.MapElementController = MapController;
