/**
 * 比例尺控件
 * 继承自StylableControl，提供比例尺显示和自动更新功能
 */

class ScaleBarControl extends StylableControl {
    constructor(options = {}) {
        super({
    ...
    getDefaultStyles() {
        if (window.StyleRegistry) {
            return window.StyleRegistry.getStyles('scale-bar');
        }
        return window.ScaleBarStyles || {};
    }
...
// 导出到全局
window.ScaleBarControl = ScaleBarControl;
