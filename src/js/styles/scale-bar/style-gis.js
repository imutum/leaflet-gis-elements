...
(function () {
    const ScaleBarGISStyle = {
        ...
        render: (scaleData) => {
            ...
            return `
                <div class="lge-scale-bar-gis" style="width: ${width}px;">
                    ...
                    <div class="lge-scale-bar-labels">
                        ...
                        <div class="lge-scale-label lge-scale-label-middle">${middleLabel}</div>
                        <div class="lge-scale-label lge-scale-label-end">${endLabel}</div>
                    </div>
                </div>
            `;
        }
    ...
    // 自动注册风格
    L.GISElements.StyleRegistry.register('scale-bar', 'gis', ScaleBarGISStyle);
})();
